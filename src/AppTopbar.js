  ...
  render() {
    ...
    let horizontalIcon = this.props.layoutMode === "horizontal" && (
      <button className="p-link topbar-logo">
        ...
        <span className="app-name">Schedule Picker</span>
      </button>
    );
          ...
          <ul className={topbarClass}>
            <li
              className={classNames("profile-item", {
                "active-topmenuitem": this.props.activeTopbarItem === "profile"
              })}
            >
              <button
                className="p-link"
            ...
            <li
              className={classNames({
                "active-topmenuitem": this.props.activeTopbarItem === "messages"
              })}
            >
              <button
                className="p-link"
              ...
              >
                <i className="topbar-icon material-icons animated swing">
                  &#xE0C9;
                </i>
            ...
            <li
              className={classNames({
                "active-topmenuitem":
                  this.props.activeTopbarItem === "notifications"
              })}
            >
              <button
                className="p-link"
