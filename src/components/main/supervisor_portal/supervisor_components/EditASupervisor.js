...
import { editSupervisor } from "../../../../store/supervisors/actions";
import SupervisorNav from "./SupervisorNav";

export class EditASupervisor extends Component {
  constructor() {
    super();
    let today = new Date();
      ...
      <div className="p-grid p-fluid ">
        <div className="p-col-12 p-lg-8">
          <div className="card card-w-title">
            ...
            <div className="card card-w-title">
              <h1> I Need to Edit This Supervisor:</h1>
              ...
              <div className="p-grid">
                <Dropdown
                  ...
                  onChange={event =>
                    this.setState({ originalName: event.value })
                  }
                  autoWidth={false}
                />
                <div>
...
export default connect(mapStateToProps, { editSupervisor })(EditASupervisor);
